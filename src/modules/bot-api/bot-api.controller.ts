...
export class BotApiController {
  ...
  @Post('sendMessage')
  sendMessage(@CurrentBot() bot: Bot, @Body() body: {
    chat_id: string; text: string;
    reply_to_message_id?: string; reply_markup?: any;
  }) {
  ...
  editMessageText(@CurrentBot() bot: Bot, @Body() body: {
    chat_id: string; message_id: string; text: string; reply_markup?: any;
  }) {
  ...
  @Post('deleteMessage')
  deleteMessage(@CurrentBot() bot: Bot, @Body() body: {
  ...
  @Post('getUpdates')
  getUpdates(@CurrentBot() bot: Bot, @Body() body: {
  ...
  @Post('setWebhook')
  setWebhook(@CurrentBot() bot: Bot, @Body() body: {
  ...
  getChatMembersCount(@CurrentBot() bot: Bot, @Body() body: { chat_id: string }) {
